...
namespace IFinancing360_ICS_UI.Components.Setting.JournalGlLinkComponent
{
  public partial class JournalGlLinkDataGrid
  {
    ...
    {
      var res = await IFINICSClient.GetRows<JsonObject>("JournalGlLink", "GetRows", new
      {
        args.Keyword,
        args.Offset,
        args.Limit
    ...
    private void Add()
    {
      NavigationManager.NavigateTo($"{ParentMenuURL}/gllink/add");
    }
    #endregion
    ...
    private async void Delete()
    {
      ...
      if (result == true)
      {
        ...
        await IFINICSClient.Delete("JournalGlLink", "Delete", id);
    ...
    protected async Task Print()
    {
      ...
      var file = await IFINICSClient.GetRow<JsonObject>("JournalGlLink", "GetReportData", null);
