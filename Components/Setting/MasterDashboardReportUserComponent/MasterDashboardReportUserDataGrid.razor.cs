...
{
  public partial class MasterDashboardReportUserDataGrid
  {
    #region Service
    ...
    private void Add()
    {
      NavigationManager.NavigateTo($"{ParentMenuURL}/masterdashboardreportuser/add");
    }
    #endregion
    ...
    private async void Delete()
    {
      ...
      if (result == true)
      {
        ...
        await IFINICSClient.Delete("MasterUser", "Delete", id);
    ...
    protected async Task Print()
    {
      ...
      var file = await IFINICSClient.GetRow<JsonObject>("MasterUser", "GetReportData", null);
