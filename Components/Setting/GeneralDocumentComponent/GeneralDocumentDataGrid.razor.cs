...
{
  public partial class GeneralDocumentDataGrid
  {
    #region Service
    ...
    {
      var res = await IFINICSClient.GetRows<JsonObject>("SysGeneralDocument", "GetRows", new
      {
        args.Keyword,
        args.Offset,
        args.Limit
    ...
    private void Add()
    {
      NavigationManager.NavigateTo($"{ParentMenuURL}/generaldocument/add");
    }
    #endregion
    ...
    private async void Delete()
    {
      ...
      if (result == true)
      {
        ...
        await IFINICSClient.Delete("SysGeneralDocument", "Delete", id);
    ...
    protected async Task Print()
    {
      ...
      var file = await IFINICSClient.GetRow<JsonObject>("SysGeneralDocument", "GetReportData", null);
