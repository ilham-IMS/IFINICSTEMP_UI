...
namespace IFinancing360_ICS_UI.Components.IncentiveCalculationComponent.Marketing.AgreementMarketingFeeComponent
{
  public partial class AgreementMarketingFeeNonInternalDataGrid
  {
    ...
    [Inject] IFINCOREClient IFINCOREClient { get; set; } = default!;
    #endregion
    ...
    {
      BodyResponse<List<JsonObject>>? res = await IFINICSClient.GetRows<JsonObject>("AgreementFee", "GetRowsByAgreementID", new
      {
        args.Keyword,
        args.Offset,
        args.Limit,
